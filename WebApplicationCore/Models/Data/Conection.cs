...
namespace API_RestFull_Prueba.Models.Data
{
    ...
    public class Connection : System.IDisposable
    {
        ...
        private SqlClientPermission pSql = new SqlClientPermission(System.Security.Permissions.PermissionState.Unrestricted);
        ...
        public void AgregarParametroSQL(string nombre, object valor, SqlDbType tipo, int longitud)
        {
            ...
            else { comando.Parameters.Add(nombre, tipo, longitud).Value = valor; }
            comando.Parameters[nombre].IsNullable = true;
        }
        //  ''' <summary>
